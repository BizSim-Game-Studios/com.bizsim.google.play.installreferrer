...
{
    /// <summary>
    /// AES-256-CBC encrypted cache provider that stores referrer data in PlayerPrefs.
    ...
    /// If decryption fails (e.g., data corruption), returns null to force re-fetch.
    ///
    ...
    /// </summary>
    public class EncryptedPlayerPrefsCacheProvider : IInstallReferrerCacheProvider
    {
        private const string PREFS_KEY = "InstallReferrer_Cache_Enc";
        private const string KEY_ID_PREFS_KEY = "InstallReferrer_KeyId";
        ...
        public EncryptedPlayerPrefsCacheProvider()
            : this("BizSimInstallReferrer_" + Application.identifier) { }
        ...
        /// <inheritdoc />
        public CachedReferrerData Load()
        {
            ...
            try
            {
                ...
                return JsonUtility.FromJson<CachedReferrerData>(json);
            }
            catch
            {
                // Decryption failed — corrupt data or device changed
                return null;
            }
        }

        /// <inheritdoc />
        public void Save(CachedReferrerData data)
        {
